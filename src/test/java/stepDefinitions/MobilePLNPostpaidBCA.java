...
public class MobilePLNPostpaidBCA extends BaseStep {
    ...
    @Then("^status pemesanan PLN Pascabayar dengan BCA VA pada halaman History berubah menjadi \"([^\"]*)\"$")
    public void status_pemesanan_PLN_Pascabayar_dengan_BCA_VA_pada_halaman_History_berubah_menjadi(String arg1) throws Throwable {

    }

    @Then("^bukti pembayaran PLN Pascabayar dengan BCA VA diterima di email pelanggan$")
    public void bukti_pembayaran_PLN_Pascabayar_dengan_BCA_VA_diterima_di_email_pelanggan() throws Throwable {
    ...
    @Then("^email transaksi PLN Pascabayar dengan BCA VA dibatalkan karena kadaluarsa akan masuk ke email pelanggan$")
    public void email_transaksi_PLN_Pascabayar_dengan_BCA_VA_dibatalkan_karena_kadaluarsa_akan_masuk_ke_email_pelanggan() throws Throwable {

    }

    @Then("^transaksi PLN Pascabayar dengan BCA VA terhapus dari History Transaksi di aplikasi mobile Sepulsa$")
    public void transaksi_PLN_Pascabayar_dengan_BCA_VA_terhapus_dari_History_Transaksi_di_aplikasi_mobile_Sepulsa() throws Throwable {
    ...
    @Then("^muncul notifikasi \"([^\"]*)\" sehingga tidak bisa bayar dengan BCA VA$")
    public void muncul_notifikasi_sehingga_tidak_bisa_bayar_dengan_BCA_VA(String arg1) throws Throwable {
    ...
    @Then("^muncul notifikasi \"([^\"]*)\" karena tagihan sudah dibayar sehingga tidak bisa bayar dengan BCA VA$")
    public void muncul_notifikasi_karena_tagihan_sudah_dibayar_sehingga_tidak_bisa_bayar_dengan_BCA_VA(String arg1) throws Throwable {
        plnPostpaid.statusGagalTampil();
    }
