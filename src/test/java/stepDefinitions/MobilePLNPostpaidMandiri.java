...
public class MobilePLNPostpaidMandiri extends BaseStep {
    ...
    public void transaksi_pemesanan_PLN_Pascabayar_dengan_metode_bayar_Mandiri_Virtual_Account_pada_halaman_History_muncul_di_daftar_Transaksi_Sukses() throws Throwable {
    ...
    public void transaksi_pemesanan_PLN_Pascabayar_dengan_metode_bayar_Mandiri_VA_pada_halaman_History_tidak_ditemukan_di_daftar_Transaksi_Sukses() throws Throwable {
        plnPostpaid.keHalamanBeranda();
        beranda.sudahDiBeranda();
        beranda.klikMenuHistory();
        history.sudahDiHistory();
    ...
    @Then("^muncul notifikasi \"([^\"]*)\" sehingga tidak bisa bayar PLN Pascabayar dengan Mandiri VA$")
    public void muncul_notifikasi_sehingga_tidak_bisa_bayar_PLN_Pascabayar_dengan_Mandiri_VA(String arg1) throws Throwable {
    ...
    @Then("^muncul notifikasi \"([^\"]*)\" karena tagihan sudah dibayar sehingga tidak bisa bayar PLN Pascabayar dengan Mandiri VA$")
    public void muncul_notifikasi_karena_tagihan_sudah_dibayar_sehingga_tidak_bisa_bayar_PLN_Pascabayar_dengan_Mandiri_VA(String arg1) throws Throwable {
        plnPostpaid.statusSudahBayarTampil();
        createScreenshots.captureScreenShots();
    }

    @When("^user mengosongkan kolom PLN / ID Pelanggan untuk bayar tagihan listrik dengan Mandiri VA$")
    public void user_mengosongkan_kolom_PLN_ID_Pelanggan_untuk_bayar_tagihan_listrik_dengan_Mandiri_VA() throws Throwable {
    ...
    public void keterangan_pelanggan_yang_akan_membayar_tagihan_listrik_dengan_metode_bayar_Mandiri_Virtual_Account_tidak_muncul() throws Throwable {
        plnPostpaid.statusTagihanTidakTampil();
        createScreenshots.captureScreenShots();
    }

    @When("^user mengosongkan kolom handphone pemilik tagihan listrik yang akan dibayar dengan Mandiri VA$")
    public void user_mengosongkan_kolom_handphone_pemilik_tagihan_listrik_yang_akan_dibayar_dengan_Mandiri_VA() throws Throwable {
